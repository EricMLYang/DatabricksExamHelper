...
```
-- 1. appendOnly: 禁止 UPDATE/DELETE
ALTER TABLE t SET TBLPROPERTIES ('delta.appendOnly' = true);

-- 2. enableChangeDataFeed: 啟用 CDF
ALTER TABLE t SET TBLPROPERTIES ('delta.enableChangeDataFeed' = true);

-- 3. logRetentionDuration: 保留歷史日誌時間
ALTER TABLE t SET TBLPROPERTIES ('delta.logRetentionDuration' = 'interval 30 days');

-- 4. deletedFileRetentionDuration: VACUUM 刪除檔案前的保留期
ALTER TABLE t SET TBLPROPERTIES ('delta.deletedFileRetentionDuration' = 'interval 7 days');

-- 5. dataSkippingNumIndexedCols: 統計資訊收集欄位數
ALTER TABLE t SET TBLPROPERTIES ('delta.dataSkippingNumIndexedCols' = 10);

-- 6. autoOptimize: 自動最佳化
